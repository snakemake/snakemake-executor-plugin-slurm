...
class TestRunJobAttemptSync:
    ...
    def test_run_job_sets_inherited_attempt(self, mock_run_job, mock_executor, mock_job):
    ...
    @patch('snakemake_executor_plugin_slurm.Executor.run_job')
    def test_run_job_cleans_up_inherited_attempt(self, mock_run_job, mock_executor, mock_job):
    ...
    def test_multiple_jobs_update_inherited_attempt(self, mock_executor, mock_job):
        ...
        for job in jobs:
            mock_executor.workflow.executor_settings._inherited_attempt = job.attempt
            assert mock_executor.workflow.executor_settings._inherited_attempt == job.attempt
